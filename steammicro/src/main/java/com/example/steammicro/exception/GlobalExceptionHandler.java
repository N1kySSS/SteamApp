package com.example.steammicro.exception;

import com.example.steamapi.dto.response.StatusResponse;
import com.example.steamapi.execption.IsDeveloperAlreadyExistsException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(IsDeveloperAlreadyExistsException.class)
    public ResponseEntity<StatusResponse> handleIsDeveloperAlreadyExists(IsDeveloperAlreadyExistsException ex) {
        return ResponseEntity
                .status(HttpStatus.CONFLICT)
                .body(new StatusResponse("error", ex.getMessage()));
    }

    @ExceptionHandler(IsGameAlreadyExistsException.class)
    public ResponseEntity<StatusResponse> handleIsGameAlreadyExists(IsGameAlreadyExistsException ex) {
        return ResponseEntity
                .status(HttpStatus.CONFLICT)
                .body(new StatusResponse("error", ex.getMessage()));
    }
